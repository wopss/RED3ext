function(configure_version_from_git)
  ...
  if(NOT RED3EXT_CI_RELEASE AND GIT_VERSION_METADATA)
  ...
  set(RED3EXT_GIT_VERSION_MAJOR ${GIT_VERSION_MAJOR} PARENT_SCOPE)
  set(RED3EXT_GIT_VERSION_MINOR ${GIT_VERSION_MINOR} PARENT_SCOPE)
  set(RED3EXT_GIT_VERSION_PATCH ${GIT_VERSION_PATCH} PARENT_SCOPE)
  set(RED3EXT_GIT_VERSION_PRERELEASE ${GIT_VERSION_PRERELEASE} PARENT_SCOPE)
  set(RED3EXT_GIT_VERSION "${GIT_VERSION}" PARENT_SCOPE)
endfunction()
